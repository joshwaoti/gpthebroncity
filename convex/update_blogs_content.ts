...
/**
 * Updates all blog posts with summarized, clean content from the PDF sermons/teachings
 */
...
**Start today. Commit to a consistent prayer life. Watch God move in your life and through your prayers.**`
            },
            {
                ...
                imageUrl: "/assets/img/blogs/stewardship.png",
...
**The question is not how much of our money we give to God, but how much of God's money we keep for ourselves.**`
            },
            {
                ...
                imageUrl: "/assets/img/blogs/identity_christ.png",
...
When believers understand their identity in Christ, lives are transformed:

- **Addicts find freedom** - No longer defined by their past
- **Depressed find hope** - Secure in God's love
- **Anxious find peace** - Trusting God's care
- **Rejected find acceptance** - Welcomed by the Father
- **Insecure find confidence** - Strong in Christ's strength
...
**You are who God says you are. Nothing more, nothing less, nothing else.**`
            },
            {
                ...
                imageUrl: "/assets/img/blogs/holy_spirit.png",
...
**Stand firm. Put on the full armor of God. Resist the devil. And watch him flee from you!**`
            },
            {
                ...
                imageUrl: "/assets/img/blogs/forgiveness.png",
...
**Today, make the choice to forgive. Let go of the past. Embrace the freedom Christ offers. And walk in the joy of forgiveness.**`
            },
            {
                ...
                imageUrl: "/assets/img/blogs/faith_trust.png",
...
**Your faith journey starts today. Take the step. Trust God. And watch Him move in your life.**`
        ...
        return {
            success: true,
            message: `Blog posts updated: ${updated}, New posts created: ${notFound}`,
